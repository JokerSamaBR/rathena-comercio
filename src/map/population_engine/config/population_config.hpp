...
struct PopulationChatProximityRule {
...
class PopulationChatDatabase : public YamlDatabase {
	...
	std::vector<PopulationChatProximityRule> proximity_rules_;
...
public:
	...
	const std::vector<PopulationChatProximityRule>& proximity_rules() const;
};
